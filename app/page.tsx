...
export default function Home() {
  return <main>
    ...
    <section className="services-band shell"><div><p className="eyebrow">For schools &amp; small businesses</p><h2>Want help bringing AI into your school or business?</h2></div><div><p>Practical staff training, clear AI policies and hands-on setup, led by a former Assistant Headteacher and Head of ICT. Start with a free consultation.</p><Link className="button button-primary" href="/work-with-us">See how we can help <ArrowUpRight size={17}/></Link></div></section>
